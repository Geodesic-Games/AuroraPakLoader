...
#include "AuroraSaveFilePathStructCustomization.h"
...
#include "Slate/SAuroraFilePathPicker.h"

#define LOCTEXT_NAMESPACE "FAuroraSaveFilePathStructCustomization"


/* IDetailCustomization interface
 *****************************************************************************/

void FAuroraSaveFilePathStructCustomization::CustomizeChildren( TSharedRef<IPropertyHandle> StructPropertyHandle, class IDetailChildrenBuilder& StructBuilder, IPropertyTypeCustomizationUtils& StructCustomizationUtils )
{
	/* do nothing */
}


void FAuroraSaveFilePathStructCustomization::CustomizeHeader( TSharedRef<IPropertyHandle> StructPropertyHandle, class FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& StructCustomizationUtils )
{
	PathStringProperty = StructPropertyHandle->GetChildHandle("FilePath");
	check(PathStringProperty);
	...
	HeaderRow
		...
		[
			SNew(SAuroraFilePathPicker)
				.BrowseButtonImage(FAppStyle::GetBrush("PropertyWindow.Button_Ellipsis"))
				.BrowseButtonStyle(FAppStyle::Get(), "HoverHintOnly")
				.BrowseButtonToolTip(LOCTEXT("FileButtonToolTipText", "Choose a file from this computer"))
				.BrowseDirectory(FEditorDirectories::Get().GetLastDirectory(ELastDirectory::GENERIC_OPEN))
				.BrowseTitle(LOCTEXT("PropertyEditorTitle", "File picker..."))
				.FilePath(this, &FAuroraSaveFilePathStructCustomization::HandleFilePathPickerFilePath)
				.FileTypeFilter(FileTypeFilter)
				.IsOpenDialog(false)
				.DialogReturnsFullPath(true)
				.OnPathPicked(this, &FAuroraSaveFilePathStructCustomization::HandleFilePathPickerPathPicked)
		];
}
...
FString FAuroraSaveFilePathStructCustomization::HandleFilePathPickerFilePath( ) const
{
	FString FilePath;
...
void FAuroraSaveFilePathStructCustomization::HandleFilePathPickerPathPicked( const FString& PickedPath )
{
