...
/**
 * Implements an editable text box with a browse button, allowing to Open or Save a file
 * Adjusted copy of SFilePathPicker
 */
class SAuroraFilePathPicker
	: public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SAuroraFilePathPicker)
	...
	{ }
		...
		/** Whether the we are trying to Open an existing file or Save, therefore allowing the section of a file that does not exist. */
		SLATE_ATTRIBUTE(bool, IsOpenDialog)
...
private:
	/** Whether the we are trying to Open an existing file or Save, therefore allowing the section of a file that does not exist. */
	TAttribute<bool> bIsOpenDialog = true;
